      ...
      <Box
        sx={{
          ...
          '&::before': {
            ...
            height: '80%',
            background:
              'radial-gradient(circle, rgba(0,201,167,0.1) 0%, rgba(255,255,255,0) 70%)',
            zIndex: 0,
          },
        }}
      />
            ...
            <Box>
              ...
              <Typography
                ...
                sx={{
                  ...
                  lineHeight: 1.1,
                  background:
                    'linear-gradient(45deg, #0056D2 30%, #00C9A7 90%)',
                  backgroundClip: 'text',
              ...
              <Typography
                ...
                sx={{ fontSize: '1.2rem', mb: 4, maxWidth: 500 }}
              >
                Restoring movement, relieving pain, and helping you get back to
                the life you love with expert care from our dedicated
                specialists.
              </Typography>
              <Button
                variant="contained"
                ...
                href="https://maps.app.goo.gl/77fGtSC7err9UZ6QA"
                target="_blank"
                rel="noopener noreferrer"
                sx={{ mr: 2, fontSize: '1.1rem', px: 4 }}
              >
                Get Directions
              </Button>
              <Button
          ...
          <Grid2 size={{ xs: 12, md: 6 }}>
            ...
            <Box
              sx={{
                ...
                background:
                  'url(https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80) center/cover',
              }}
            >
          ...
          {[
            {
              ...
              color: 'primary.main',
              desc: 'Schedule a visit with our experts',
            },
            {
              title: 'Our Services',
