      ...
      <Container maxWidth="lg">
        <Grid2 container spacing={8} alignItems="center">
          <Grid2 size={{ xs: 12, md: 6 }}>
            ...
            <Typography
              variant="body1"
              sx={{ opacity: 0.9, fontSize: '1.1rem', lineHeight: 1.8, mb: 4 }}
            >
              At Ortho Solution, we combine cutting-edge technology with
              compassionate care. Our integrated approach ensures that you
              receive the best possible treatment for a speedy recovery. We are
              proud to be recognized for our dedication to patient outcomes.
            </Typography>
            <Button
              variant="contained"
              color="secondary"
